...
static const float GB_OUTLINE_CUTOFF_SEA = 0.998f; // Magic number to balance cutoff on edges without neighbor (over Sea)
...
static const float GB_STRENGTH_CH1 = 0.99; // Opacity of bottom layer
static const float GB_STRENGTH_CH2 = 0.99; // Opacity of top layer
